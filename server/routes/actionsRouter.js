...
// Middleware
const { validateAction, validateActionId, validateProjectId } = require("../middleware/middleware.js");
...
router.post("/", validateProjectId, validateAction, (req, res) => {
  Actions.insert(req.body)
    ...
    .catch(() =>
      res.status(404).json({
        error:
          "There was an error when trying to add this action to the database."
      })
    );
});
...
// PUT ("/actions/:id")
router.put("/:id", validateProjectId, validateAction, validateActionId,(req, res) => {
